...
\begin{tikzpicture}
	...
	\draw[thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (3.5, 2.5);
	\draw[c1, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c1, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c1, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c1, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c1, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c1, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c1, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c1, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (3.5, 3.5);
	\draw[c2, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c2, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c2, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c2, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c2, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c2, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c2, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c2, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (2.5, 3.5);
	\draw[c3, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c3, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c3, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c3, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c3, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c3, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c3, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c3, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (1.5, 3.5);
	\draw[c4, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c4, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c4, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c4, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c4, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c4, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c4, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c4, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (1.5, 2.5);
	\draw[c5, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c5, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c5, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c5, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c5, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c5, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c5, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c5, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (1.5, 1.5);
	\draw[c6, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c6, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c6, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c6, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c6, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c6, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c6, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c6, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (2.5, 1.5);
	\draw[c7, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c7, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c7, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c7, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c7, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c7, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c7, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c7, thick, -stealth] (x) -- ++ (1/2, -1/2);

	\coordinate (x) at (3.5, 1.5);
	\draw[c8, thick, -stealth] (x) -- ++ (1/2, 0);
	\draw[c8, thick, -stealth] (x) -- ++ (0, 1/2);
	\draw[c8, thick, -stealth] (x) -- ++ (-1/2, 0);
	\draw[c8, thick, -stealth] (x) -- ++ (0, -1/2);
	\draw[c8, thick, -stealth] (x) -- ++ (1/2, 1/2);
	\draw[c8, thick, -stealth] (x) -- ++ (-1/2, 1/2);
	\draw[c8, thick, -stealth] (x) -- ++ (-1/2, -1/2);
	\draw[c8, thick, -stealth] (x) -- ++ (1/2, -1/2);
